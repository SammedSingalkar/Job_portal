    ...
    <div class="row">
        ...
        <form action="update_profile.php" method="post">
                <div class="form-group">
                    <label>User ID:</label>
                    <input type="text" class="form-control" value="<?php echo $user_ID; ?>" name = "Job_seeker_ID" disabled>
                </div>
                <div class="form-group">
                    <label>Name:</label>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" value="<?php echo  $birth_date; ?>" name = "birthdate">
                </div>
